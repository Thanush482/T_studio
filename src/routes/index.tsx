  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="relative mx-auto flex max-w-md flex-col items-center px-6 pt-16 pb-12 text-center">
        ...
        <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-accent shadow-[0_0_60px_-10px_oklch(0.62_0.24_295/0.6)]">
